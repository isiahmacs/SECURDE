				...
				<form method = "checkOut" action = "POST">
					<form method = "updateCart" action = "POST">
		                <table id = "itemCart" cellspacing = "0" cellpadding = "0">
							...
							<tr>
								<td style="display: flex; flex-wrap: nowrap; align-items: center;"><img src = "images/Shopify-Uncaged03-patch01_small.jpg"></img>Uncaged 03 Embroidered Patch</td>
								<td align = "center" id = "itemPrice">$10.00</td>
								...
								<td class = "priceTag" align = "center">$10.00</td>
							</tr>
						</table>
						<p id = "subtotal">Subtotal: $10.00</p> <br>
